...
def terrain_value_iteration(np.ndarray [DTYPE_t, ndim=2] terrain_mtx, np.ndarray [DTYPE_t, ndim=1] source, np.ndarray [DTYPE_t, ndim=1] target, np.ndarray [DTYPE_t, ndim=1] steps, Py_ssize_t max_horizon, DTYPE_t append):
